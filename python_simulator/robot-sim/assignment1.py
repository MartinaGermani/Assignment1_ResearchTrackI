...
def aligned_but(rot_y_amoung):
	...
	if rot_y_amoung < -a_th:  #If the golden token in front of the robot is on the left respect to it, then the robot turns right and then goes on
        	print("turn right and then go on")
        	turn(+2, 8)
        	drive(10,6)
        elif rot_y_amoung > a_th: #If the golden token in front of the robot is on the right respect to it, then the robot turns left and then goes on
